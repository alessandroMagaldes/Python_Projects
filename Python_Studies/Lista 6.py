'''
FALTOU CORRIGIR A FUNÇÃODISTA10
CORREÇÃO: CONVERTER OU CONSIDERAR O NÚMERO COMO POSITIVO (VALOR ABSOLUTO)
...
def troca(s):
    ...
    if len(s) <= 1:
        ...
        new_str2 = new_str2 + s[-1]
        new_str2 = new_str2 + s[1:-1]
        new_str2 = new_str2 + s[0]
        return new_str2
    return 
